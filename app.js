...
// Check if we are coming back from OAuth2 login
if (window.location.href.includes('code=') || window.location.href.includes('state=')) {
    ...
    FHIR.oauth2.authorize({
        clientId: '0be0b3ac-b0ae-40da-97a3-d74a4b66f3d7',  // <<< your real client_id
        scope: 'launch/patient patient/*.read openid profile offline_access',
        redirectUri: 'https://saurabhmindbowser.github.io/SMART-EMBEDED/', // <<< Github hosted app
    });
}
